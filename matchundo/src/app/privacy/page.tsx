    ...
    <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-12 flex-1 flex flex-col justify-start">
      ...
      <div className="space-y-6 text-xs text-zinc-400 leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p>
            If you wish to update, modify, correct, or permanently delete screening information you submitted or believe should be removed, please contact us at <code className="text-zinc-200">policy@matchundo.demosnap.tech</code>.
          </p>
        </section>
      </div>
    </div>
